...
classification:
  ...
  tech_areas:
    - "azure"
    - "vm"
    # Autres: vivo, vitro, vivo-solr, tomcat, rdf, sparql, triplestore,
    #         solr, packer, bicep, tls, nsg, docker, java, bash

# Tags libres pour recherche flexible
tags: ["azure-marketplace", "vm", "vivo"]
...
- [Décrire le problème principal dans le contexte vivo-marketplace]
- [Impact actuel du problème sur le déploiement VIVO ou la certification Marketplace]

**2. Quelles sont les contraintes et exigences?**
- **Techniques**: [Ex: Compatibilité VIVO, version Java, triplestore, TLS]
- **Azure Marketplace**: [Ex: Exigences Microsoft certification VM, sécurité]
- **Client final**: [Ex: Universités, centres de recherche - facilité de déploiement]
- **Open Source**: [Ex: Compatibilité licence Apache 2.0, dépendances]
...
- **Stack VIVO**: [Contraintes Vitro, vivo-solr, Tomcat, triplestore]
...
- ✅ **Open Source Compliance**: [Compatibilité licence Apache 2.0 VIVO]
...
| Tomcat | 9.x / 10.x | Serveur VIVO/Vitro | Requis par VIVO |
| vivo-solr | Latest stable | Moteur recherche | Composant VIVO |
...
| Dépendances VIVO upstream | 🟡 Moyen | 🟡 Moyen | Version pinning, tests régression | @dev-team | Continu |
...
| **Phase 2: Intégration VIVO** | 2 semaines | - Installation VIVO complète<br>- Configuration triplestore<br>- TLS actif | - Image OS de base validée | - VIVO accessible<br>- SPARQL endpoint OK | @dev-team |
...
graph TD
    ...
    C -->|Bloque| D[Phase 2: Intégration VIVO]
...
- ⚠️ Nouvelle version majeure VIVO / Vitro disponible
...
- [VIVO Documentation](https://vivoweb.org/info/about-vivo)
...
**Exemples noms fichiers (contexte vivo-marketplace)** :
```bash
000-META-processus-creation-adr.md            # Méta (000-099)
100-ARCH-vivo-triplestore-architecture.md     # Architecture (100-199)
200-INFRA-azure-vm-image-packer.md            # Infrastructure (200-299)
300-SEC-tls-network-security-groups.md        # Sécurité (300-399)
400-DATA-rdf-triplestore-choice.md            # Données (400-499)
...
- [ ] Conformité open source (Apache 2.0 VIVO) vérifiée
